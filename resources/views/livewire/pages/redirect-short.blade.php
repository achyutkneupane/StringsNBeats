<div>
    <title>{{ $this->long->description ? ucwords($this->long->description).' - ' : '' }}{{ config('app.name', 'Laravel') }}</title>
    <meta name="title" content="{{ $this->long->description ? ucwords($this->long->description).' - ' : '' }}{{ config('app.name', 'Laravel') }}">
    ...
    <meta property="og:title" content="{{ $this->long->description ? ucwords($this->long->description).' - ' : '' }}{{ config('app.name', 'Laravel') }}">
    ...
    <meta name="twitter:title" content="{{ $this->long->description ? ucwords($this->long->description).' - ' : '' }}{{ config('app.name', 'Laravel') }}">
