<div>
    ...
    <meta http-equiv="refresh" content="1; url={{ $this->long->long }}">
    ...
    <div class='d-flex flex-column justify-content-center text-center align-items-center vw-100 vh-100 px-2'>
        Redirecting to
        <br>
