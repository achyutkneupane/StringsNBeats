<div>
    <title>{{ ucwords($this->description) }} - {{ config('app.name', 'Laravel') }}</title>
    <meta name="title" content="{{ ucwords($this->description) }} - {{ config('app.name', 'Laravel') }}">
    ...
    <meta property="og:title" content="{{ ucwords($this->description) }} - {{ config('app.name', 'Laravel') }}">
    ...
    <meta name="twitter:title" content="{{ ucwords($this->description) }} - {{ config('app.name', 'Laravel') }}">
