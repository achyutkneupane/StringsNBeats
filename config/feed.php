...
return [
    'feeds' => [
        ...
        'international' => [
             ...
             * ['App\Model@getAllFeedItems', 'argument']
             */
            'items' => 'App\Models\Article@getFeedInternational',

            /*
             * The feed will be available on this url.
             */
            'url' => '/feed/internationals',

            'title' => 'Strings N\' Beats International Feed',
            'description' => 'RSS Feed for International coverages in  Strings N\' Beats.',
            'language' => 'en-US',
